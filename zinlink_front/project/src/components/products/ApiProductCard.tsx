...
const getImageUrl = () => {
  ...
  // Otherwise use your LIVE backend domain
  return `https://admin.zinlinktech.xyz/storage/${product.image_url.replace(/^\/?storage\//, '')}`;
};
  /* ------------------------- LIST VIEW ------------------------- */
                    ...
                    {product.category === 'cctv' ? (
                      <>
                        <div>
                          ...
                          <span className="ml-1 text-gray-900">
                            {product.resolution || 'Not specified'}
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-500">Night Vision:</span>
                          <span className="ml-1 text-gray-900">
                            {product.night_vision ? 'Yes' : 'No'}
                          </span>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <span className="ml-1 text-gray-900">
                            {product.power_supply || 'Not specified'}
                          </span>
                        </div>
                      </>
                      ...
                      <>
                        <div>
                          ...
                          <span className="ml-1 text-gray-900">
                            {product.output_voltage || 'Not specified'}
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-500">Output Current:</span>
                          <span className="ml-1 text-gray-900">
                            {product.output_current || 'Not specified'}
                          </span>
                        </div>
                        <div>
                          ...
                          <span className="ml-1 text-gray-900">
                            {product.connector_type || 'Not specified'}
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-500">
                          ...
                          <span className="ml-1 text-gray-900">
                            {product.compatible_brands || 'Not specified'}
                          </span>
                        </div>
                      </>
                      ...
                      <>
                        <div>
                          ...
                          <span className="ml-1 text-gray-900">
                            {product.wifi_standard || 'Not specified'}
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-500">Speed:</span>
                          <span className="ml-1 text-gray-900">
                            {product.wifi_speed || 'Not specified'}
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-500">Coverage:</span>
                          <span className="ml-1 text-gray-900">
                            {product.coverage || 'Not specified'}
                          </span>
                        </div>
                        <div>
                          <span className="text-gray-500">Antennas:</span>
                          <span className="ml-1 text-gray-900">
                            {product.antennas || 'Not specified'}
                          </span>
                        </div>
                      </>
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <span className="ml-1 text-gray-900">
                            {product.compatibility || 'Not specified'}
                          </span>
                        </div>
                      </>
                    ) : (
  ...
  return (
    <Link to={`/products/${product.id}`} className="group block">
      <div className="relative bg-white/70 backdrop-blur-lg rounded-2xl shadow-xl border-2 border-transparent transition-all duration-300 overflow-hidden hover:scale-105 hover:-translate-y-1">
        {/* Image */}
        <div className="relative aspect-square bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2 z-10">
            {product.condition === 'new' && (
              <span className="px-2 py-1 bg-gradient-to-r from-green-400 to-blue-500 text-white text-xs font-bold rounded-full shadow-lg">
                New
              </span>
            )}
            {product.condition === 'refurbished' && (
              <span className="px-2 py-1 bg-gradient-to-r from-blue-400 to-purple-500 text-white text-xs font-bold rounded-full shadow-lg">
                Refurbished
              </span>
            )}
            ...
            {product.is_active && (
              <span className="px-2 py-1 bg-gradient-to-r from-yellow-400 to-red-500 text-white text-xs font-bold rounded-full shadow-lg">
                Featured
              </span>
            )}
          </div>
          ...
          <div className="absolute top-3 right-3 z-10">
            <button
              ...
              className="p-2 bg-white/80 rounded-full shadow-md hover:bg-pink-100 transition-colors duration-300"
            >
          ...
          <div className="absolute bottom-3 left-3 right-3 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <button
              onClick={handleAddToCart}
              className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold py-2 rounded-xl shadow-lg transition-all duration-300 active:scale-95"
              disabled={product.stock_quantity <= 0}
            >
